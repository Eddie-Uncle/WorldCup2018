...
docker run -ti -rm -e TZ=America/Sao_Paulo -e WITH_EMOJIS=1 cedricbl/world-cup-2018-cli-dashboard
```

Replace `America/Sao_Paulo` with your actual timezone. Set `WITH_EMOJIS` to `1` to enable emojis.
